...
pdf("/home/mdubbelaar/Desktop/APP23_results/Test/APP23/Plots/heatmaps_containing_most_genes.pdf") 
...
write.table(DE.ExpressionWT , "/home/mdubbelaar/Desktop/APP23_results/Test/APP23/Made_Documents/DifferentialGenesWT.txt", row.names = F, col.names = geneColsWT, sep = "\t")
write.table(DE.ExpressionHET , "/home/mdubbelaar/Desktop/APP23_results/Test/APP23/Made_Documents/DifferentialGenesHET.txt", row.names = F, col.names = geneColsHET, sep = "\t")
write.table(DE.ExpressionCombi , "/home/mdubbelaar/Desktop/APP23_results/Test/APP23/Made_Documents/DifferentialGenesHET-WT.txt", row.names = F, col.names = geneColsCombi, sep = "\t")
