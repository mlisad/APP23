...
#                           Filtering Data                         #
####################################################################
toptable1 <- createToptableResults(lrt01, "/home/mdubbelaar/Desktop/APP23_results/Test/Human/Made_Documents/")
####################################################################
#                         Creating DE Files                        #
####################################################################
...
write.table(DE.Expression , "/home/mdubbelaar/Desktop/APP23_results/Test/Human/Made_Documents/DifferentialExpressionGenotypes.txt", row.names = F, col.names = geneColsHuman, sep = "\t")
