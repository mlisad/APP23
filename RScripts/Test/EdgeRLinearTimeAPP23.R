...
calculateMaineffectsInteraction(dge.timepoints, design.timepoints, "/home/mdubbelaar/Desktop/APP23_results/Test/APP23/Made_Documents/All_ages/", "/home/mdubbelaar/Desktop/APP23_results/Test/APP23/Plots/all_ages_heatmaps.pdf", c(1:24))
...
resultsOlderMice <- calculateMaineffectsInteraction(dgeOlderMice, designOlderMice, "/home/mdubbelaar/Desktop/APP23_results/Test/APP23/Made_Documents/6-18-24M_old_mice/", "/home/mdubbelaar/Desktop/APP23_results/Test/APP23/Plots/old_mice_heatmaps.pdf", c(7:24))
...
plotMostExpr(resultsOlderMice, which(resultsOlderMice[[2]][[1]]$FDR < 0.01 & resultsOlderMice[[2]][[1]]$logFC > .075), which(resultsOlderMice[[3]][[1]]$FDR < 0.01 & resultsOlderMice[[3]][[1]]$logFC > .05),
             7:24, "/home/mdubbelaar/Desktop/APP23_results/Test/APP23/Plots/AgeAndLinearOld.pdf")
####################################################################
...
resultsYoungerMice <- calculateMaineffectsInteraction(dgeYoungerMice, designYoungerMice, "/home/mdubbelaar/Desktop/APP23_results/Test/APP23/Made_Documents/2M-6M_old_mice/","/home/mdubbelaar/Desktop/APP23_results/Test/APP23/Plots/young_mice_heatmaps.pdf", c(1:12))
...
plotMostExpr(resultsYoungerMice, which(resultsYoungerMice[[2]][[1]]$FDR < 0.01 & resultsYoungerMice[[2]][[1]]$logFC > .15), which(resultsYoungerMice[[3]][[1]]$FDR < 0.05),
             1:12, "/home/mdubbelaar/Desktop/APP23_results/Test/APP23/Plots/AgeAndLinearYoung.pdf")
