...
#setwd("/Users/mldubbelaar/APP23/CreatedData/WGCNA/")
####################################################################
...
pdf("/home/mdubbelaar/Desktop/WGCNA/Scale_Indepencence_Mean_Connectivity.pdf")
...
pdf("/home/mdubbelaar/Desktop/WGCNA/DynamicTreeCut.pdf")
...
pdf("/home/mdubbelaar/Desktop/WGCNA/MergedDynamicTreeCut.pdf")
#pdf("/Users/mldubbelaar/Desktop/MergedDynamicTreeCut.pdf")
...
pdf("/home/mdubbelaar/Desktop/WGCNA/Module-trait_RelationshipNormal.pdf")
#pdf("/Users/mldubbelaar/Desktop/Stage/APP23/WGCNA/Module-trait_RelationshipNormal.pdf")
par(mar = c(6, 8.5, 3, 3))
...
# The correlation values and the p-values are shown in the heatmap correlation plot.
pdf("/home/mdubbelaar/Desktop/WGCNA/Module-trait_RelationshipAB.pdf")
#pdf("/Volumes/Elements_Marissa/School/Stage/APP23/WGCNA/Module-trait_RelationshipAB.pdf")
par(mar = c(6, 8.5, 3, 3))
# The rows of the heatmap correspond to the module eigengene and each row
# is known to a traits. The cells in the heatmap contain the correlation
# adn the p-value.
...
# AB42 all together. 
pdf("/home/mdubbelaar/Desktop/WGCNA/CorrelationAB.pdf")
par(mfrow=c(1,2))
...
pdf("/home/mdubbelaar/Desktop/WGCNA/ModuleMemberships.pdf")
...
write.csv(geneInfo, "/home/mdubbelaar/Desktop/WGCNA/geneInfoAge.csv")
#write.csv(geneInfo, "/Users//mldubbelaar/Desktop/geneInfoAge.csv")
###################################################################
...
# traits.
pdf("/home/mdubbelaar/Desktop/WGCNA/VisualizationNetwork.pdf")
...
###################################################################
pdf("/home/mdubbelaar/Desktop/WGCNA/ModulesBarplot.pdf")
...
pdf("/home/mdubbelaar/Desktop/WGCNA/ModulesBoxplot.pdf")
...
length(rownames(t(scale(t(M2))[, moduleCols == "turquoise"])))

pdf("/home/mdubbelaar/Desktop/WGCNA/Heatmaps.pdf")
#pdf("/Users/mldubbelaar/Desktop/Heatmaps.pdf")
for (which.module in names(table(modName))){
...
# of a specific gene.
geneModule <- read.csv("/home/mdubbelaar/Desktop/WGCNA/GeneSignificance/geneInfoAge.csv")
#geneModule <- read.csv("/Users//mldubbelaar/Desktop/geneInfoAge.csv")
...
userListEnrichment(toupper(listGenes), labelR = categories,
                                  nameOut = "/home/mdubbelaar/Desktop/WGCNA/userListEnrichment/Enrichment.csv", 
...
for (module in names(table(modName))){
  ...
  exportNetworkToVisANT(modTOM, file= paste("/Users/mldubbelaar/Desktop/VisANTInput-", module, ".txt", sep=""),
  ...
  exportNetworkToVisANT(modTOM[top, top], file= paste("/Users/mldubbelaar/Desktop/VisANTInput-", module, "-top50.txt", sep=""),
                        weighted = T, threshold = 0, probeToGene = data.frame(rownames(M2), BioM[,3]))
}
