...
pdf(paste(resultPathway,"Scale_Indepencence_Mean_Connectivity.pdf", sep=""))
...
pdf(paste(resultPathway, "DynamicTreeCut.pdf", sep=""))
...
# of a specific gene.
geneModule <- read.csv(paste(resultPathway, "GeneSignificance/geneInfoAge.csv", sep=""))
